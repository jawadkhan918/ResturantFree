...
import com.rapidzz.project.Manager.CategoriesList;
import com.rapidzz.project.Model.CategoryAdapter;
import com.rapidzz.project.Model.Dishes;
import com.rapidzz.project.Manager.ItemList;
import com.rapidzz.project.Model.Items;
import com.rapidzz.project.Model.Order;
import com.rapidzz.project.Manager.OrderList;
                    ...
                    if (extras != null) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < dishesList.size(); i++) {
                                ...
                                pnObj.put("remarks", dishesList.get(i).getDishRemarks());
                                jsonArray.put(pnObj);

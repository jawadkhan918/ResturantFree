...
import com.rapidzz.project.Fragments.NumberGuestsFragment;
import com.rapidzz.project.Manager.OrderList;
import com.rapidzz.project.R;
import com.rapidzz.project.Fragments.TabFragment;
import com.rapidzz.project.Model.TableModel;
...
public class MainActivity extends Activity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onResume() {
        ...
        listItems.addAll(tabArr);*/
            ...
            for (int i = 0; i < listItems.size(); i++) {
                if (OrderList.get().getOrders().containsKey(listItems.get(i).getTable_id())) {
                  listItems.get(i).setOccupied(false);

...
public class OrderingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.recyclerview_order_layout, container, false);
        ...
        sendBtn = (Button) rootView.findViewById(R.id.sendButton);
    ...
    private  class MyRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == TYPE_ITEM) {
                View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.ordering_fragment, parent, false);
                return new VHItem(v);
